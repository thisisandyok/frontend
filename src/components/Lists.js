...
function ListList() {
    ...
    useEffect(() => {
        const fetchData = async () => {
            ...
            const listData = await axios
                .get('https://api.laffo.com/api/lists', { withCredentials: true });
    ...
    const onChange = ( (event) => {
        ...
        if(event.currentTarget.checked) {
            axios.put('https://api.laffo.com/api/subscription', {list: event.currentTarget.value},{ withCredentials: true })
            ...
            axios.delete(`https://api.laffo.com/api/subscription/${event.currentTarget.value}` , { withCredentials: true })
